...
/* MODULE_LICENSE("GPL v2"); -- moved to raw modinfo */
/* MODULE_IMPORT_NS("DMA_BUF"); -- moved to raw modinfo */
/* MODULE_DESCRIPTION -- moved to raw modinfo */

/* Raw modinfo entries for modpost compatibility on kernel 6.18+
 * When building multi-file out-of-tree modules, MODULE_INFO macros prepend
 * KBUILD_MODNAME which causes modpost to miss the tags. */
